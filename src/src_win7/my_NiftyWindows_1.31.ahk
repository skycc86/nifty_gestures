...
TRY_TrayEvent:
	...
	{
		SYS_TrayTipText = Copyright (c) 2004-2005 by Enovatic-Solutions.`nAll rights reserved. Use is subject to license terms.`n`nCompany:`tEnovatic-Solutions (IT Service Provider)`nAuthor:`t`tOliver Pfeiffer`, Bremen (GERMANY)`nEmail:`t`tniftywindows@enovatic.org`n`n*skycc customize ver 1.31
	...
	If ( TRY_TrayEvent = "skycc86" )
		Run, https://sites.google.com/site/skycc86/pc-tech/my-apps/
